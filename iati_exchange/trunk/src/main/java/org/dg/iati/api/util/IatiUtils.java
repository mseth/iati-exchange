...
//	        t.transform(source,new StreamResult(System.out));
	...
	public static List<IatiMappingElement> generateIATIElements() {
		...
		new IatiMappingElement("reporting-org",Arrays.asList(Constants.IATI_ATTRIBUTE_OWNER_REF,Constants.IATI_ATTRIBUTE_TYPE, Constants.IATI_ATTRIBUTE_OWNER_NAME), true),
		new IatiMappingElement("title",Arrays.asList(Constants.IATI_ATTRIBUTE_LANG), true),
