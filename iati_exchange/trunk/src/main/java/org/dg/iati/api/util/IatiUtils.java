...
public class IatiUtils {
	...
	public static List<IatiMappingElement> generateIATIElements() {
		...
		new IatiMappingElement("reporting-org",Arrays.asList(Constants.IATI_ATTRIBUTE_REF, Constants.IATI_ATTRIBUTE_ROLE, Constants.IATI_ATTRIBUTE_TYPE, Constants.IATI_ATTRIBUTE_LANG), true),
		new IatiMappingElement("title",Arrays.asList(Constants.IATI_ATTRIBUTE_LANG), true),
